  ...
  static String getLastInteractiveMessage(
    ...
    switch (messageType) {
      case MessageTypeConstants.form:
        subtitle = Translations.of(context).form_message;
        break;
      case MessageTypeConstants.card:
        subtitle = Translations.of(context).card_mesage;
        break;
        case MessageTypeConstants.scheduler:
          SchedulerMessage schedulerMessage =SchedulerMessage.fromInteractiveMessage( message as InteractiveMessage);
          String meetingMessage  = SchedulerUtils.getSchedulerTitle(schedulerMessage, context);
