...
///[ReactionsEmojiKeyboardStyle] is a data class that has styling-related properties
///to customize the appearance of [ReactionsEmojiKeyboard]
class ReactionsEmojiKeyboardStyle {
  ReactionsEmojiKeyboardStyle(
